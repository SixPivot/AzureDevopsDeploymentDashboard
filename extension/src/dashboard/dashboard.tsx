...
export class Dashboard extends React.Component<{}, IPipelineContentState> {
  ...
  public componentDidMount() {
    ...
    SDK.ready().then(() => {
      SDK.getService<IProjectPageService>(CommonServiceIds.ProjectPageService).then((projectService) => {
          ...
          <Card>
            {this.state.isLoading ? (
              ...
              <div className="font-size-m flex-grow text-center padding-vertical-20">
                ...
                <Link className="no-underline-link" target="_top" href="https://learn.microsoft.com/en-us/azure/devops/pipelines/process/deployment-jobs?view=azure-devops">Learn more</Link> about deployment jobs and how to set them up in your pipelines.
